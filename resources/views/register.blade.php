    ...
    <div class="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-md space-y-8">
            <div>
                ...
                <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Sign up to your account
                </h2>
            ...
            <form class="mt-8 space-y-6" action="{{ Route('register.post') }}" method="POST">
                ...
                <div class="-space-y-px rounded-md shadow-sm">
                    <div>
                        ...
                        <input id="email-address" name="name" type="name" autocomplete="name" required
